...
{
    internal class DeviceService(IMemoryCache memoryCache, IDeviceRepository deviceRepository, IUserDeviceRoleRepository userDeviceRoleRepository) : IDeviceService
    {
